        ...
        \subsection{Non-Maximum Suppression}
            ...
            \begin{figure}[H]
                ...
                \begin{tikzpicture} [node distance=7cm, auto]
                    \tikzstyle{line} = [draw, -latex']
                    \node (image1) {\includegraphics[width=.3\textwidth]{obrazky/nms/before.png}};
                    \node (image2) [right of=image1] {\includegraphics[width=.3\textwidth]{obrazky/nms/after.png}};
            ...
            \begin{figure}[H]
                ...
                \begin{tikzpicture}[node distance=.3cm, auto]
                    ...
                    \node [block, below=of prepare] (filter_conf) {Z množiny orámovní $B$ odstráň orámovania s prinískou dôveryhodnosťou
...
\chapter{Vyhodnotenie kvality detekcie}
    ...
    \section{Kvalita orámovania}
        ...
        \begin{equation}
            IoU = \frac{Obsah(B_{pravda} \bigcap B_{predikcia})}{Obsah(B_{pravda} \bigcup B_{predikcia})} = \frac{\includegraphics[height=3cm]{obrazky/metrics/intersection.drawio.png}}{\includegraphics[height=3cm]{obrazky/metrics/union.drawio.png}}
        \end{equation}
...
\chapter{Návrh usporiadania hardvérových komponentov}
    ...
    \section{Kryt zariadenia}
        ...
        \begin{figure}[H]
            \centering
            \begin{tikzpicture} [node distance=7cm, auto]
                \node (image1) {\includegraphics[width=.45\textwidth]{obrazky/case/pi camera device front view.png}};
                \node (image2) [right of=image1] {\includegraphics[width=.45\textwidth]{obrazky/case/pi camera device transparent front.png}};
            \end{tikzpicture}
        ...
        \begin{figure}[H]
            \centering
            \begin{tikzpicture} [node distance=7cm, auto]
                \node (image1) {\includegraphics[width=.45\textwidth]{obrazky/case/pi camera device back cover opened.png}};
                \node (image2) [right of=image1] {\includegraphics[width=.45\textwidth]{obrazky/case/pi camera device back transparent.png}};
            \end{tikzpicture}
...
\chapter{Tvorba datasetu}
    ...
    \section{Získavanie dát}
        ...
        \begin{enumerate}
            ...
            \item Kontrola, nastavenie a~vygenerovanie novej inštancie datasetu. Pred stiahnutím archívu s~anotovaným datasetom, je potrebné nastaviť parametre, ako~požadované rozlíšenie, spôsob zarovnania tvaru snímok (čierne pozadie, výrez, roztiahnuť, zrkadlenie). Taktiež je možné aplikvať nastavené randomizované augmentácie na~náhodne vybrané snímky z~trénovacieho datasetu. Po nastavení počtu generovaných snímok je možné vygenerovať a stiahnuť dataset.
        ...
        \begin{figure}[H]
            ...
            \end{tikzpicture}
            \caption{Ukážka niekoľkých snímkov z datasetu}
        \end{figure}
...
User=<užívateľ>
    ...
    \section{Návrh grafického rozhrania}
        ...
        Zoznam na~pravej strane obrazovky obsahuje prepínače rozhodjúce o~tom, ktoré z~možných  zobraziteľných dát sú vľavo vykresľované. V~zozname sú zobrazené len prepínače pre~tie typy dát ktoré sú produkované aktuálnymi aktívnymi modulmi.
