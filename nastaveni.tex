...
%  [tituly před jménem]{Křestní}{Příjmení}[tituly za jménem]
% Pokud osoba nemá titul před/za jménem, smažte celý řetězec '[...]'
\advisor[Ing.]{Ilona}{Janáková}[Ph.D.]
...
\keywrds[%
  ...
  počítačové videnie, detekcia objektov, trasovanie, klasifikácia, lietajúce objekty, mikropočítače, dataset
}

%% Poděkování
\acknowledgement{%
  Chcel by som poďakovať pani Ing. Ilone Janákovej Ph.D. za jej cenné vedenie, trpezlivosť a podporu pri mojej technickej diplomovej práci.
